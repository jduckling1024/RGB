	...
	<body>
		...
		<div class="content details-page">
			...
			<div class="product-details">
				...
				<input type="hidden" name="rFilepath" value="${myRoomPath}">
				<input type="hidden" id = "fFilepath" name="fFilepath" >
                   	</form>
					<div class="clear"> </div>
				</div>
				<div class="details-right">
					<div><span>방 정보: ${widthSize} × ${heightSize}</span><a href="#">돌아가기</a></div>
                    <div class="arrangeImage" style="overflow:auto">
                    
                    <c:forEach var="list" items="${imageList}">
								<img class="image" src="${list.path}" onclick="make();">
							</c:forEach>
                       <!--  <img class="image" src="/resources/image_arrange_ap/fabricsopaFront.png" onclick="make()">
                        <img cfselass="image" src="/resources/image_arrange_ap/fabricsopaFSide.png" onclick="make()">
