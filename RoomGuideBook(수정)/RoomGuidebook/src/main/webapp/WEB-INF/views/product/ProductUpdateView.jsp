	...
	<input name="id" value="${product.id}">
		...
		<div id="content-wrapper" class="content">
			...
			<div id="image_container3">
				<img alt="" src="${mainImage.path}" height="250px" width="250px"
					style="margin-left: 2.5%; margin-right: 2.5%;">
			</div>
			<div id="image_container1">
				<c:forEach var="infoImage" items="${infoImage}">
					<img alt="" src="${infoImage.path}" height="250px" width="250px"
					style="margin-left: 2.5%; margin-right: 2.5%;">
				</c:forEach>
			</div>
			...
			<c:forEach var="arrangeImage" items="${arrangeImage}">
				<img alt="" src="${arrangeImage.path}" height="250px" width="250px"
					style="margin-left: 2.5%; margin-right: 2.5%;">
				</c:forEach>
			</div>
		</div>
