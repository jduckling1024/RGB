...
<script>
	...
	var ProductInsertResult = '${ProductInsertResult}';
	
	if(ProductInsertResult == "success"){
		alert("상품 등록을 완료하였습니다.");
	}else if(ProductInsertResult == "fail"){
		alert("상품 등록 중 알 수 없는 오류가 발생했습니다.");
	}
	
	var ProductUpdateResult = '${ProductUpdateResult}';
	if(ProductUpdateResult == "success"){
		alert("상품 수정을 완료하였습니다.");
	}else if(ProductUpdateResult == "fail"){
		alert("상품 수정 중 알 수 없는 오류가 발생했습니다.");
	}
...
<script type="text/javascript">
    ...
    function updateProduct(){
        ...
        if(cnt == 0){
        	...
        	var productInfo = document.productInfo;
			productInfo.action = "updateProductFrom";
			productInfo.method = "post";
			productInfo.submit();
        }else{
        	alert("하나의 항목만 선택하십시오.");
        }
    }
</script>
...
<body id="page-top">
	...
	<div id="content-wrapper" class="content">
		...
		<Div class="buttonGroup">
			<ul>
				<li><input type="button" class="modifyBtn" value="수정" onclick="updateProduct();"></li>
