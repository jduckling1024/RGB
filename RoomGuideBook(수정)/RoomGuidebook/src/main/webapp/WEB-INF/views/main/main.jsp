	...
	<div class="img-slider">
		<div class="wrap">
			...
			%>
				...
				<li><a href="/getFurniture?id=${image.divisionId}"> 
				<img src="${image.path}" alt="" />
					...
					<div class="slider-detils">
						...
						<a class="slide-btn" href="/getFurniture?id=${image.divisionId}"> Shop Now</a>
					</div>
					</li>
		...
		<div class="wrap">
			<div class="content-right">
				<div class="product-grids">
					...
					<!---//caption-script---->
					<!-- 게시물 정보1 시작-->
					<c:forEach var="list" items="${boardImageList}">
						<div onclick="location.href='details.html';"
							...
							<div class="product-pic">
								<a href="#"><img src="${list.path}" title="product-name" /></a>
								<p>
