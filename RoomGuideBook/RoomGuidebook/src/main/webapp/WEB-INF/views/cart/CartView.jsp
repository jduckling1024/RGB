                ...
                <form name="cartForm">
                  ...
                  %>
                    ...
                    <div class="rightSection">
                        ...
                        pageContext.setAttribute("productSumStr", formatter.format(productSum));
                        pageContext.setAttribute("delevaryFeeStr", formatter.format(delevaryFee));
                        pageContext.setAttribute("priceSumStr", formatter.format(priceSum));
                        %>
                        <table class="priceInfoTable">
                                <tr>
                                    <th>총 상품금액</th>
                                    <td>${productSumStr} KRW</td>
                                </tr>
                                <tr>
                                    <th>총 배송비</th>
                                    <td>${delevaryFeeStr} KRW</td>
                                </tr>
                                <tr>
                                    <th>결제금액</th>
                                    <td>${priceSumStr} KRW</td>
                                </tr>
                            </table>
